...
public class CadastroClienteGUI extends javax.swing.JPanel {
    ...
    public void preencherParaEdicao(Long id) {
        ...
        if (cliente != null) {
            ...
            if (cliente.getEstado() != null) jComboBoxEstado.setSelectedItem(cliente.getEstado());
            ...
            jFormattedTextFieldCPF.setText(cliente.getDocumento());
    ...
    private void salvarCliente() {
        try {
            String cep = br.edu.senai.fatesg.avcar.swing.views.telas.utils.FormatadorUtil.extrairNumeros(jFormattedTextFieldCEP);
            String tel = br.edu.senai.fatesg.avcar.swing.views.telas.utils.FormatadorUtil.extrairNumeros(jFormattedTextFieldTelefone);
            String cpfCnpj = br.edu.senai.fatesg.avcar.swing.views.telas.utils.FormatadorUtil.extrairNumeros(jFormattedTextFieldCPF);
            String estado = jComboBoxEstado.getSelectedItem().toString();

            if (this.idClienteEmEdicao != null) {
                // ATUALIZAÇÃO (EDITAR)
                var req = new br.edu.senai.fatesg.avcar.business.clientes.ClienteController.AtualizarClienteRequest(
                    jTextFieldNome.getText(), jTextFieldEndereco.getText(), jTextFieldBairro.getText(),
                    jTextFieldCidade.getText(), estado, cep, tel, jTextFieldEmail.getText(), 
                    cpfCnpj, null, null, null, null, null, null
                );
                clienteController.atualizar(idClienteEmEdicao, req);
            } else {
                // NOVO CLIENTE
                if (jRadioButtonPessoaFisica.isSelected()) {
                    var req = new br.edu.senai.fatesg.avcar.business.clientes.ClienteController.CriarPFRequest(
                        jTextFieldNome.getText(), jTextFieldEndereco.getText(), jTextFieldBairro.getText(),
                        jTextFieldCidade.getText(), estado, cep, tel, jTextFieldEmail.getText(), 
                        cpfCnpj, null, null, null
                    );
                    clienteController.criarPF(req);
                } else {
                    var req = new br.edu.senai.fatesg.avcar.business.clientes.ClienteController.CriarPJRequest(
                        jTextFieldNome.getText(), jTextFieldEndereco.getText(), jTextFieldBairro.getText(),
                        jTextFieldCidade.getText(), estado, cep, tel, jTextFieldEmail.getText(), 
                        cpfCnpj, null, null, null
                    );
